 ...
 * proxies the provider so that we can go in at entity manager creation time and
 * set the eclipselink target-server to be {@link OSGiTSServer}.
 */
  ...
  public Object getService(Bundle bundle, ServiceRegistration registration) {
    ...
    try {
      Class<? extends PersistenceProvider> providerClass =
          (Class<? extends PersistenceProvider>) eclipseLinkJpaBundle.loadClass(Activator.ECLIPSELINK_JPA_PROVIDER_CLASS_NAME);
